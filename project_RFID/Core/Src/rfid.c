...
{
  TRX_PHASE_IDLE = 0,
  TRX_PHASE_SET_BITFRAMING,
  TRX_PHASE_SET_IDLE_CMD,
  TRX_PHASE_CLEAR_IRQ,
  TRX_PHASE_FLUSH_FIFO,
  TRX_PHASE_WRITE_FIFO,
  TRX_PHASE_ENABLE_IRQ,
  TRX_PHASE_SET_TRANSCEIVE,
  TRX_PHASE_START_SEND,
  TRX_PHASE_WAIT_IRQ,
  TRX_PHASE_CLEAR_STARTBIT,
  TRX_PHASE_CHECK_ERROR,
  TRX_PHASE_READ_FIFO_LEVEL,
  TRX_PHASE_READ_CONTROL,
  TRX_PHASE_READ_FIFO,
  TRX_PHASE_FINISH
} rc522_trx_phase;
